...
class Generator:
    ...
    def generate_textbook(self, course_title):
        ...
        textbook_preface = self.textbook_generator.generate_textbook_table(self.agent, textbook_title, textbook_table)
    ...
    def generate_chapter(self, chapter_title):
        ...
        chapter_summary = self.generate_chapter_summary(chapter_title, chapter_section, chapter_summary)
    ...
    def generate_section(self, section_title):
        ...
        section_example = self.generate_section_description(section_title, section_description)
